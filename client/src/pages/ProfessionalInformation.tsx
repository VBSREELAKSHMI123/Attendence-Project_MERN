...
const ProfessionalInformation = ({ setTabValue, profformValues, setprofformValues }: ProfessionalTypes) => {
  ...
  return (
    ...
    <div className='flex flex-col gap-7'>
      ...
      <div className='flex gap-5 items-center'>
        <div className='flex-1 h-10'>
          <InputField label="" value={profformValues.working} name='working' onChange={inputHandler} type="text" placeholder="Working Days" />
          <p className='text-[12px] text-red-500 mt-1'>
